...
void grab_gauche(uint8_t sn_right, uint8_t sn_left, uint8_t sn_clamp, uint8_t sn_gyro, uint8_t sn_sonar, uint8_t motor[2], float value, float gyro_val, float gyro_abs, FLAGS_T state)
{
    ...
    set_tacho_speed_sp(sn_right, max_speed/6);
    set_tacho_speed_sp(sn_left, max_speed/6);
