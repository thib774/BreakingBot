...
void demi_tour(uint8_t sn_right, uint8_t sn_left, uint8_t sn_gyro, uint8_t motor[2], float value, float gyro_val, float gyro_abs, FLAGS_T state)
{
        //printf("Demi tour...\n" );
        init_gyro = init_gyro - 180;
